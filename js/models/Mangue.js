 ...
 */
class Mangue extends ElementMobile {
    ...
    constructor() {
        ...
        this.ajouterTexture(mangue_fin_20);
        this.ajouterTexture(mangue_fin_30);
        this.ajouterTexture(mangue_fin_40);
        this.ajouterTexture(mangue_fin_50);
        this.ajouterTexture(mangue_fin_60);
        this.ajouterTexture(mangue_fin_70);
        this.ajouterTexture(mangue_fin_80);
        this.ajouterTexture(mangue_fin_90);
