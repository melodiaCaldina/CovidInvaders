 ...
 */
class Orange extends ElementMobile {
    ...
    constructor() {
        ...
        this.ajouterTexture(orange_fin_20);
        this.ajouterTexture(orange_fin_30);
        this.ajouterTexture(orange_fin_40);
        this.ajouterTexture(orange_fin_50);
        this.ajouterTexture(orange_fin_60);
        this.ajouterTexture(orange_fin_70);
        this.ajouterTexture(orange_fin_80);
        this.ajouterTexture(orange_fin_90);
