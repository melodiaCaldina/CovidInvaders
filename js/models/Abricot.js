 ...
 */
class Abricot extends ElementMobile {
    ...
    constructor() {
        ...
        this.ajouterTexture(Abricot_fin_20);
        this.ajouterTexture(Abricot_fin_30);
        this.ajouterTexture(Abricot_fin_40);
        this.ajouterTexture(Abricot_fin_50);
        this.ajouterTexture(Abricot_fin_60);
        this.ajouterTexture(Abricot_fin_70);
        this.ajouterTexture(Abricot_fin_80);
        this.ajouterTexture(Abricot_fin_90);
